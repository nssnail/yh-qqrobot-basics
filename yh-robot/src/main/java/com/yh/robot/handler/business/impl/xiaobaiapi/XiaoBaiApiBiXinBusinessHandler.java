 ...
 * @author nssnail
 * @Description TODO
 * @createTime 2023年04月11日 11:47:00
 */
@HandleService(value = "XiaoBaiApiBiXinBusinessHandler"
        , handleType = HandleType.REMOVE
        , sendType = SendMsgType.IMAGE
        , handleName = "xiaobaiAPi 比心")
public class XiaoBaiApiBiXinBusinessHandler implements RobotBusinessHandler {
    ...
    public List<String> handle(MessageVo messageVo) {
        return Collections.singletonList(xiaoBaiApi.getBiXin(messageVo.getMsg()));
    }
}