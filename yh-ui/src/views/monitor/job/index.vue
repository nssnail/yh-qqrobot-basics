    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          ...
          <el-col v-if="form.isMessage == 0" :span="24">
          ...
          <el-col v-if="form.isMessage == 1" :span="12">
...
import { listAll } from "@/api/robot/messageTemplate";

export default {
  components: { Crontab },
  name: "Job",
  dicts: ["sys_job_group", "sys_job_status", "yes_no_enum"],
  data() {
    return {
      // 遮罩层
      loading: true,
