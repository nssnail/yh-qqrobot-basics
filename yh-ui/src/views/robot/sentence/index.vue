<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['robot:sentence:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['robot:sentence:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['robot:sentence:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="sentenceList" @selection-change="handleSelectionChange">
      <el-table-column label="长句难句" align="center" prop="sentence" />
      <el-table-column label="翻译" align="center" prop="translation" />
      <el-table-column label="年份" align="center" prop="year" />
      <el-table-column label="解释" align="center" prop="sentenceExplain" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="长句难句" prop="sentence">
          <el-input v-model="form.sentence" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="翻译" prop="translation">
          <el-input v-model="form.translation" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="年份" prop="year">
...
<script>
import { listSentence, getSentence, delSentence, addSentence, updateSentence } from "@/api/robot/sentence";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除英语长句难句编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('robot/sentence/export', {
        ...this.queryParams
